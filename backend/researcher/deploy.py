...
def main():
    print("Prime Researcher Service - Docker Deployment")
    print("===========================================")
    ...
    ecr_repository = "prime-researcher"
    ...
    try:
        services = run_command([
            ...
            "--region", region,
            "--query", "ServiceSummaryList[?ServiceName=='prime-researcher'].ServiceArn",
            "--output", "json"
        ], capture_output=True)
        ...
        if services:
            ...
            if service_arns:
                        ...
                        "ImageRepository": {
                            ...
                            "ImageConfiguration": {
                                ...
                                "RuntimeEnvironmentVariables": {
                                    ...
                                    "PRIME_API_ENDPOINT": os.environ.get("PRIME_API_ENDPOINT", "")
                                }
                            },
                ...
                print("  2. Select 'prime-researcher' service")
